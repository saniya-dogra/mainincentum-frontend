...
export default function LoginPage() {
  ...
  // ✅ Remove any trailing slash from backend URL (prevents //api errors)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ✅ Safe concatenation — no double slash possible
      ...
      const { userId, ...userData } = response.data.data;
      const formattedUser = { id: userId, ...userData };
